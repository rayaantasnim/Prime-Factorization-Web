/**
 * PrimeFactor.app — Web Audio API Sound Synthesizer
 * Zero External MP3 Dependencies. 100% Hermetic Synthesized Sound FX.
 */
...
export function playSound(type) {
  ...
  try {
    ...
    console.debug('Audio error or blocked:', err);
  }
}
